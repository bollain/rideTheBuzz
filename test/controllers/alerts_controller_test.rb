...
class AlertsControllerTest < ActionController::TestCase
  ...
  test "should create alert" do
    assert_difference('Alert.count') do
      post :create, alert: { bus: @alert.bus, latitude: @alert.latitude, longitude: @alert.longitude, number: @alert.number }
    end
  ...
  test "should update alert" do
    patch :update, id: @alert, alert: { bus: @alert.bus, latitude: @alert.latitude, longitude: @alert.longitude, number: @alert.number }
    assert_redirected_to alert_path(assigns(:alert))
  end

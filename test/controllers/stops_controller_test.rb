...
class StopsControllerTest < ActionController::TestCase
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post :create, stop: { atStreet: @stop.atStreet, lat: @stop.lat, lon: @stop.lon, onStreet: @stop.onStreet, stopNumber: @stop.stopNumber }
    end
  ...
  test "should update stop" do
    patch :update, id: @stop, stop: { atStreet: @stop.atStreet, lat: @stop.lat, lon: @stop.lon, onStreet: @stop.onStreet, stopNumber: @stop.stopNumber }
    assert_redirected_to stop_path(assigns(:stop))
  end

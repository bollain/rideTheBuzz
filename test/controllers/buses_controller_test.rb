...
class BusesControllerTest < ActionController::TestCase
  ...
  test "should create bus" do
    assert_difference('Bus.count') do
      post :create, bus: { destination: @bus.destination, direction: @bus.direction, latitude: @bus.latitude, longitude: @bus.longitude }
    end
  ...
  test "should update bus" do
    patch :update, id: @bus, bus: { destination: @bus.destination, direction: @bus.direction, latitude: @bus.latitude, longitude: @bus.longitude }
    assert_redirected_to bus_path(assigns(:bus))
  end
